...
\begin{itemize}
    ...
    \item \(n=1{,}000{,}000\), runs \(=1\) (quick sort, merge sort, and radix sort all completed successfully; bubble sort measurements are from a previous run; insertion sort and selection sort were not run at this size)
\end{itemize}
