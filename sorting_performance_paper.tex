...
\bottomrule
\end{tabular}
\caption{Bubble sort at \(n=1{,}000{,}000\): average elapsed time (ms). Single run. All remaining algorithms crashed before completing at this size (see Section~\ref{sec:notes}).}
\label{tab:bubble-1m}
\end{table}
