...
\begin{itemize}
    ...
    \item \(n=1{,}000{,}000\), runs \(=1\) (quick sort, merge sort, radix sort, and selection sort all completed; bubble sort measurements are from a previous run; insertion sort was not run at this size)
\end{itemize}
